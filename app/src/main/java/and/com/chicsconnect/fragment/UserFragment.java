...
import and.com.chicsconnect.ProfileActivity;
import and.com.chicsconnect.R;
import and.com.chicsconnect.adapter.UserProfileViewHolder;
...
public class UserFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference().child("Users").child(country).child(state).child(city);
    }
