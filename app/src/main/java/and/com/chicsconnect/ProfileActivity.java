...
import and.com.chicsconnect.adapter.WorldViewHolder;
import and.com.chicsconnect.model.Users;
import and.com.chicsconnect.model.World;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        userProfileName.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "OpenSans-Regular.ttf"));
        userProfileEmail.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "OpenSans-Light.ttf"));
        userProfileBio.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "OpenSans-Light.ttf"));
    }
}